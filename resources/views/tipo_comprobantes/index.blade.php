...
@section('content')
<div class="card">
    <div class="card-header">Tipo Comprobante
        <a class="btn btn-primary btn-sm float-right text-white" href="{{route('tipo_comprobantes.create')}}">Nuevo</a>
    </div>
...
<script>
    ...
    url2="{{route('tipo_comprobantes.destroy',":id")}}";
