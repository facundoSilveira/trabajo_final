...
@section('content')
<div class="card">
    <div class="card-header">Tipo Recursos
        <a class="btn btn-primary btn-sm float-right text-white" href="{{route('tipo_recursos.create')}}">Nuevo</a>
    </div>
...
<script>
    ...
    url2="{{route('tipo_recursos.destroy',":id")}}";
