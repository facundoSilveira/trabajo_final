...
<div class="card">
    <div class="card-header">
        ...
        <div class="float-right">
            <button title="Desplegar filtros" data-card-widget="collapse" data-target="#demo" class="btn primary bg-light"><i
    ...
    <div class="card-body">
        <div class="table-responsive table-bordered table-sm">
            <table id="auditorias" class="table table-bordered table-striped table-hover dataTable">
                ...
                <tbody>
                    @foreach($auditoriasMovimiento as $auditoria)
                    <tr>
                        ...
                        <td width="150px" class="text-center">
                            <a href="{{ route('auditoria.showMovimientos', ['auditoria' => $auditoria->auditable_id, 'id' => $auditoria->id])}}"
                    ...
                    @endforeach
                    @foreach($auditoriasPedido as $auditoria)
                    <tr>
                        <td>{{$auditoria->auditable_id}}</td>
                        <td>PEDIDOS</td>
                        <td style="text-transform:uppercase">{{$auditoria->event}}</td>
                        ...
                        <td width="150px" class="text-center">
                            <a href="{{ route('auditoria.showPedidos', ['auditoria' => $auditoria->auditable_id, 'id' => $auditoria->id])}}"
                                class="btn btn-xs btn-primary">Ver mas</a>
