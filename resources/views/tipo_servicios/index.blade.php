...
@section('content')
<div class="card">
    <div class="card-header">Tipo Servicio
        <a class="btn btn-primary btn-sm float-right text-white" href="{{route('tipo_servicios.create')}}">Nuevo</a>
    </div>
...
<script>
    ...
    url2="{{route('tipo_servicios.destroy',":id")}}";
