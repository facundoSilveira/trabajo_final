...
@section('content')
    ...
    <form class="form-group" method="POST" action="/modelos/{{$modelo->id}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre" value="{{$modelo->nombre}}"class="form-control">
            </div>
