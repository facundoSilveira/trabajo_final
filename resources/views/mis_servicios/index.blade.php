    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-dark " id="tabla">
            ...
            <tbody>
                ...
                <td><span class="badge @if($servicio->getEstado()=='Finalizado') bg-success @elseif($servicio->getEstado()=='Entregado' || $servicio->getEstado()=='Cancelado') bg-light @elseif($servicio->getEstado()=='En Proceso' || $servicio->getEstado()=='En Revision') bg-warning @elseif($servicio->getEstado()=='En Espera') bg-danger @elseif($servicio->getEstado()=='Confirmado' || $servicio->getEstado()=='Pendiente') bg-info  @endif">{{$servicio->getEstado()}}</span></td>
    ...
    $(document).ready(function () {
      ...
      $('#filtrar').click(function () {
        ...
        if (filtro1 != "" && filtro2 == "" && filtro3 == "" && filtro4 == "") {
          ...
          var filtros = "F. desde: " + filtro1Titulo+", F. hasta: " + filtro2Titulo +" y prioridades: "+String(filtro3);
          var filtradoTabla = function FuncionFiltrado(settings, data, dataIndex) {
            var datearray1 = data[2].split("/");
            var newdate1 =   datearray1[2] + datearray1[1] + datearray1[0];
          ...
          var filtradoTabla = function FuncionFiltrado(settings, data, dataIndex) {
            if (prioridades.includes(data[1])) {
              return true;
