            ...
            <div class="card-body box-profile">
                ...
                <ul>
                    <li class="list-group-item">
                        ...
                        <form class="form-group" method="POST" action="{{route('servicios.atender_servicio', ['servicio' => $servicio->id])}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="servicio" value="{{$servicio}}">

                        <a type="button" href="{{route('informes.getServicio', $servicio->id)}}" class="btn btn-primary "><i class="fa fa-check"></i> Generar informe</a>
                        </form>
                    </li>
