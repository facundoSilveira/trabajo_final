            ...
            <div class="card-body box-profile">
                ...
                <ul>
                    <li class="list-group-item">
                        ...
                        <form class="form-group" method="GET" action="{{route('servicios.atender_servicio', ['servicio' => $servicio->id])}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="servicio" value="{{$servicio}}">

                        <button type="submit" class="btn btn-primary "><i class="fa fa-check"></i> Atender</button>
                        </form>
                    </li>
