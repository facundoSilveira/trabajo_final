...
@section('content')
<div class="card">
    <div class="card-header">Prioridades
        <a class="btn btn-primary btn-sm float-right text-white" href="{{route('prioridades.create')}}">Nuevo</a>
    </div>
...
<script>
    ...
    url2="{{route('prioridades.destroy',":id")}}";
